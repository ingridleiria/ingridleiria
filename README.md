...
In research that means panel data, difference in differences and survival models. In practice it means the forecast,
...
Ten authenticated resale platforms are scraped every day and written into a longitudinal panel, one observation per
listing per day, which makes price trajectories and time to sale reconstructable. That panel feeds hedonic price
models, value retention, and survival models of how quickly a bag actually sells. Trilingual product on React,
Node.js and PostgreSQL with pgvector.

### [econos-ai](https://github.com/ingridleiria/econos-ai)
...
Applied microeconometrics: Brazilian higher education, illegal markets, entrepreneurial entry. Three research prizes
from Brazil's federal and regional economics councils between 2016 and 2018, for work on decision making under
